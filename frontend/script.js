...
if (window.location.pathname.includes('dashboard.html')) {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Agregar event listeners para modales de proveedores solo si existen
...
document.addEventListener('DOMContentLoaded', function() {
    // Event listeners para modales de proveedores (solo si existen)
    const addSupplierModal = document.getElementById('addSupplierModal');
    if (addSupplierModal) {
        addSupplierModal.addEventListener('click', function(e) {
            if (e.target === this) {
    ...
    // Event listeners para formularios de proveedores (solo si existen)
